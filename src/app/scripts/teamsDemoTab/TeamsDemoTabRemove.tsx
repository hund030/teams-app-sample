...
export interface ITeamsDemoTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITeamsDemoTabRemoveProps {

}

/**
 * Implementation of teams demo Tab remove page
 */
export class TeamsDemoTabRemove  extends TeamsBaseComponent<ITeamsDemoTabRemoveProps, ITeamsDemoTabRemoveState> {
